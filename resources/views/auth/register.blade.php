        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
            <div class="bg-green-700 p-4 sm:p-8 md:p-12 lg:p-16 flex items-center justify-center">
                <div class="w-full max-w-md">
                    <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold text-yellow-400 text-center mb-3">Register</h1>
                    <p class="text-center text-green-100 mb-6 sm:mb-8">Create your PASYA account and start using data-driven agriculture tools.</p>

                    <form method="POST" action="{{ route('register', absolute: false) }}" class="space-y-4 sm:space-y-5">
                        @csrf
                        ...
                        <div class="flex flex-col gap-3 pt-2 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <button
                                type="submit"
                                class="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 px-8 rounded-full transition-colors duration-200 shadow-lg hover:shadow-xl sm:w-auto"
                            >
                                Create Account
                            </button>
                        </div>
            ...
            <div class="bg-green-100 p-4 sm:p-8 md:p-12 lg:p-16 flex flex-col items-center justify-center text-center">
                <div class="mb-4 sm:mb-6">
                    <img
                        src="{{ asset('images/PASYA.png') }}"
                        alt="Benguet Agriculture Logo"
                        class="w-32 h-32 sm:w-48 sm:h-48 md:w-64 md:h-64 object-contain mx-auto drop-shadow-lg"
                    />
                </div>
                <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-green-800 mb-4">Grow With Confidence</h2>
