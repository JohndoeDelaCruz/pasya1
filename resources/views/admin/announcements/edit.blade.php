    ...
    <div class="admin-feature-announcement-editor mx-auto max-w-5xl space-y-5 p-3 sm:p-6">
        ...
        <div class="admin-feature-page-header flex flex-col gap-4 border-b border-gray-200 pb-5 sm:flex-row sm:items-end sm:justify-between">
            <div class="max-w-2xl">
                ...
                <h1 class="mt-1 text-2xl font-semibold tracking-tight text-gray-950 sm:text-3xl">Edit announcement</h1>
                <p class="mt-2 text-sm leading-6 text-gray-600">Changes affect the audience currently able to see this announcement.</p>
            </div>
